...
import {Table, TableBody, TableCell, TableContainer, TableRow, Paper, IconButton, Button, CircularProgress, AppBar, Toolbar, Typography} from '@material-ui/core';
import {Add as AddIcon, UnfoldMore as UnfoldMoreIcon, Assignment as AssignmentIcon, MoreVert as MoreVertIcon, } from '@material-ui/icons'
...
export default function StudentsDataGrid() {
  ...
  return (
    <TableContainer component={Paper}>
      ...
      <Container>
        <Row>
          <Col md={{ span: 4, offset: 4 }} style={{position: "relative", left: "20vw"}} >
            <Button color="error" variant="contained" >
              <AddIcon />&nbsp; New Assignments
            </Button>
          </Col>
        </Row>
      </Container>
