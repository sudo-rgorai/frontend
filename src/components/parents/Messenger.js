		...
		<Container style={{ marginTop: "100px" }}>
			<Row>
				<Col md={4} style={{ padding: "20px" }}>
					<Paper
						elevation={3}
						style={{ minHeight: window.innerWidth >= 900 ? "600px" : "0px" }}>
						<Container>
							<Typography
								variant="h6"
								gutterBottom
								style={{ paddingTop: "15px", color: "#3f51b5" }}>
								Contacts
							</Typography>
							<br />
							<ChatList
					...
					<Paper
						...
						<Container>
							<Typography
								variant="h6"
								gutterBottom
								style={{ paddingTop: "15px", color: "cyan" }}>
								Adam
							</Typography>
							...
							/>
							<div
								style={{ bottom: "20px", position: "absolute", width: "92%" }}>
								<Input
