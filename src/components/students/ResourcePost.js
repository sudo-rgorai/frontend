		...
		<Card className={classes.root}>
			...
			<CardContent>
				<Typography variant="body2" color="textSecondary" component="p">
					...
					animi maxime eveniet numquam harum quis incidunt accusamus eligendi
					architecto, aliquid vel rerum quas veritatis dolorum ut fugit atque
					corporis. Sit.
				</Typography>
			</CardContent>
				...
				<CardContent>
					...
					<List>
						<ListItem>
							...
							<ListItemText
								primary="Person 1"
								secondary="Great work! Thanks for the help. Really appreciated."
							/>
						</ListItem>
						<ListItem>
							<ListItemAvatar>
