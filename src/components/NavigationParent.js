...
import { makeStyles, useTheme, Drawer, AppBar, Toolbar, List, ListItem, ListItemIcon, ListItemText, Typography, Divider, IconButton, Collapse } from "@material-ui/core";
import { Menu, ChevronLeft, ChevronRight, Home, People, CalendarToday, LocalActivity, QuestionAnswer, ExpandLess, ExpandMore, Announcement, Chat } from '@material-ui/icons';
    ...
    <>
      ...
      >
        <div className={classes.toolbar}>
          <Typography variant="h6" noWrap>Parents Portal&nbsp;</Typography>
