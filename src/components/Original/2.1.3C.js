...
<div style={{padding: '5% 10%'}}>
	<div class="row" style={{textAlign:'center'}}>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Add Online Video Link</Modal.Title>
        </Modal.Header>
        <Modal.Body>
	<div style={{margin: '0% 5%'}}>

	<div style={{margin: '0.2% 2%'}}>
	<p>Paste Link</p></div>
	...
	<input type="text" name="text" style={{width:'100%', backgroundColor:'#e5e4e2', border:'none', borderRadius:'5px',margin:'0 0 1% 0'}}/>
